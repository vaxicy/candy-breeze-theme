#!/usr/bin/env python3
"""Generate VS Code Marketplace store screenshots for Candy Breeze Theme.
...
SAMPLE = [
    ...
    ("}", "keyword"),
    ("", None),
    ("// Candy Breeze — a palette for focused coding", "comment"),
    ("class User {", "keyword"),
    ...
    ("}", "keyword"),
    ("", None),
    ("const u = new User(42, 'Candy Breeze');", "variable"),
...
def draw_screenshot(theme_name, out_name):
    ...
    d.text((14, 10), "Candy Breeze Theme", font=font(14, True), fill=title_fg)
...
if __name__ == "__main__":
    draw_screenshot("candy-breeze-light-color-theme.json", "screenshot-light.png")
    draw_screenshot("candy-breeze-dark-color-theme.json", "screenshot-dark.png")
